...
add_theme_support( 'genesis-style-selector', array( 'generate-blue' => 'Blue', 'generate-green' => 'Green', 'generate-orange' => 'Orange' ) );

/** Child theme (do not remove) */
define( 'CHILD_THEME_NAME', 'DonnaDB Theme' );
define( 'CHILD_THEME_URL', 'http://dan.daviesbrackett.com/themes/donnadb' );
...
add_filter( 'genesis_footer_creds_text', 'nuke_footer');
function nuke_footer()
{
    $newFooter = '[footer_copyright before="Copyright " after=" Donna Davies Brackett"] &middot; [footer_loginout]';
    return $newFooter;
}
...
genesis_register_sidebar( array(
    'id' => 'home-sidebar',
    'name' => 'Home Sidebar',
    'description' => 'This is the sidebar that appears only on the home page',
) );
